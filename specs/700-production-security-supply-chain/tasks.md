...
- [ ] **T-802 · Bounded strings e invariantes de DynamicData** (REQ-701/703)
...
- [ ] **T-803 · Normalização CDR e RAII do decode dinâmico** (REQ-702)
...
- [ ] **T-804 · Publicação dinâmica por schema real** (REQ-703)
...
- [ ] **T-805 · Boundary HTTP autenticada e limitada** (REQ-704)
